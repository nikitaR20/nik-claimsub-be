from sqlalchemy import Column, String, Text, Boolean, Date, TIMESTAMP, ForeignKey
...
class Segment(Base):
    __tablename__ = "segments"   # changed table name here
...
class Claim(Base):
    ...
    risk_id = Column(UUID(as_uuid=True), nullable=True)  # Can add FK later if risk_ratings model added
